...
import info.gl.coopcycle.repository.CooperativeRepository;
import info.gl.coopcycle.service.CooperativeService;
...
/**
 * REST controller for managing {@link info.gl.coopcycle.domain.Cooperative}.
 */
@RestController
@RequestMapping("/api")
