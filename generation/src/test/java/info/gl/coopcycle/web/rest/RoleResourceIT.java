...
import info.gl.coopcycle.repository.RoleRepository;
import info.gl.coopcycle.service.dto.RoleDTO;
import info.gl.coopcycle.service.mapper.RoleMapper;
...
class RoleResourceIT {
    ...
    public static Role createEntity(EntityManager em) {
        Role role = new Role().role(DEFAULT_ROLE);
        return role;
    }
    ...
    public static Role createUpdatedEntity(EntityManager em) {
        Role role = new Role().role(UPDATED_ROLE);
        return role;
    }
