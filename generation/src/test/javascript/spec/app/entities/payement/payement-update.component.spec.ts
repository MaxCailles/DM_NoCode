...
import PayementUpdateComponent from '@/entities/payement/payement-update.vue';
import PayementClass from '@/entities/payement/payement-update.component';
...
describe('Component Tests', () => {
  describe('Payement Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<PayementClass>(PayementUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        // GIVEN
        const entity = { id: 123 };
        comp.payement = entity;
        payementServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(payementServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.payement = entity;
        payementServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(payementServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        payementServiceStub.retrieve.resolves([foundPayement]);
