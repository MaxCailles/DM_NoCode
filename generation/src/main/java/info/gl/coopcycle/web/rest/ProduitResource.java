...
import info.gl.coopcycle.repository.ProduitRepository;
import info.gl.coopcycle.service.ProduitService;
...
/**
 * REST controller for managing {@link info.gl.coopcycle.domain.Produit}.
 */
@RestController
@RequestMapping("/api")
