...
import info.gl.coopcycle.repository.UtilisateurRepository;
import info.gl.coopcycle.service.UtilisateurService;
...
/**
 * REST controller for managing {@link info.gl.coopcycle.domain.Utilisateur}.
 */
@RestController
@RequestMapping("/api")
