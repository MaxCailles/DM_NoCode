...
import info.gl.coopcycle.repository.RestaurantRepository;
import info.gl.coopcycle.service.dto.RestaurantDTO;
import info.gl.coopcycle.service.mapper.RestaurantMapper;
...
class RestaurantResourceIT {
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().nom(DEFAULT_NOM);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().nom(UPDATED_NOM);
        return restaurant;
    }
    ...
    void putNewRestaurant() throws Exception {
        ...
        updatedRestaurant.nom(UPDATED_NOM);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.nom(UPDATED_NOM);
