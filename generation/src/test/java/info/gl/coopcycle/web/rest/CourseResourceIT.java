...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().numero(DEFAULT_NUMERO).date(DEFAULT_DATE);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().numero(UPDATED_NUMERO).date(UPDATED_DATE);
        return course;
    }
    ...
    void createCourse() throws Exception {
        ...
        assertThat(testCourse.getNumero()).isEqualTo(DEFAULT_NUMERO);
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.numero(UPDATED_NUMERO).date(UPDATED_DATE);
        ...
        Course testCourse = courseList.get(courseList.size() - 1);
        assertThat(testCourse.getNumero()).isEqualTo(UPDATED_NUMERO);
    ...
    void fullUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.numero(UPDATED_NUMERO).date(UPDATED_DATE);
