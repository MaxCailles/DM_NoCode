...
class PanierResourceIT {
    ...
    private static final Integer DEFAULT_PRIXTOTAL = 0;
    private static final Integer UPDATED_PRIXTOTAL = 1;
    ...
    public static Panier createEntity(EntityManager em) {
        Panier panier = new Panier().prixtotal(DEFAULT_PRIXTOTAL);
        return panier;
    }
    ...
    public static Panier createUpdatedEntity(EntityManager em) {
        Panier panier = new Panier().prixtotal(UPDATED_PRIXTOTAL);
        return panier;
    }
    ...
    void createPanier() throws Exception {
        ...
        assertThat(testPanier.getPrixtotal()).isEqualTo(DEFAULT_PRIXTOTAL);
    }
    ...
    void getAllPaniers() throws Exception {
        ...
        restPanierMockMvc
            ...
            .andExpect(jsonPath("$.[*].prixtotal").value(hasItem(DEFAULT_PRIXTOTAL)));
    }
    ...
    void getPanier() throws Exception {
        ...
        restPanierMockMvc
            ...
            .andExpect(jsonPath("$.prixtotal").value(DEFAULT_PRIXTOTAL));
    }
    ...
    void putNewPanier() throws Exception {
        ...
        updatedPanier.prixtotal(UPDATED_PRIXTOTAL);
        ...
        Panier testPanier = panierList.get(panierList.size() - 1);
        assertThat(testPanier.getPrixtotal()).isEqualTo(UPDATED_PRIXTOTAL);
    }
    ...
    void fullUpdatePanierWithPatch() throws Exception {
        ...
        partialUpdatedPanier.prixtotal(UPDATED_PRIXTOTAL);
